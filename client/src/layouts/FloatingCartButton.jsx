...
const FloatingCartButton = () => {
    ...
    return (
        <motion.button
            ...
            className="fixed bottom-6 right-6 z-[80] flex h-14 items-center gap-3 rounded-full bg-ink px-5 text-lightCream shadow-2xl transition-colors duration-500 hover:bg-red sm:bottom-8 sm:right-8"
        >
