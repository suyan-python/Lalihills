...
const Coffee = () => {
  ...
  const filteredProducts = useMemo(() => {
    return coffeeProducts.filter((product) => {
      // Roast
      if (product.roastLevel > filters.roastLevel) {
        return false;
      }

      // Caffeine
      if (filters.caffeine !== "all" && product.caffeine !== filters.caffeine) {
        return false;
      }

      // Profile
      if (product.profile < filters.profile) {
        return false;
      }
