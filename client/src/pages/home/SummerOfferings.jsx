      ...
      <div className="mx-auto max-w-[1700px]">
        <div className="mx-auto max-w-3xl text-center">
          <motion.h2
            ...
            className="mt-6 subheader text-[clamp(4rem,6vw,7rem)] leading-[0.9] tracking-[-0.055em] text-lightCream"
          >
            From the <br />
            <span className="ml-3 italic text-red">Hills</span>
          </motion.h2>
          ...
          >
            From the richness of Nepal's highlands to the hands that bring it to
            you. Explore what Laali Hills brings home from the hills.
          </motion.p>
        </div>
