...
================================================== */}
            ...
            ================================================= */}
                                ...
                                <div className="relative pl-7">
                                    ...
                                    <div className="absolute left-0 top-0 h-[420px] w-[1px] bg-brown/10" />
                                    ...
                                    <motion.div
                                        ...
                                        className="absolute left-0 top-0 h-[420px] w-[2px] bg-red"
                                    />
                ...
                ================================================= */}
                                    ...
                                    <motion.div
                                        ...
                                        className="absolute left-[-5px] z-20 -translate-y-1/2"
                                    >

                                        <div className="relative flex h-3 w-3 items-center justify-center rounded-full bg-cream">
                ...
                ================================================= */}
                                    ...
                                    >
                                        ...
                                        <p className="font-title text-4xl leading-[0.88] tracking-[-0.05em] text-brown xl:text-5xl">
                                            From the
                ...
                ================================================= */}
                                    ...
                                    <div className="mb-20">
                                        ...
                                        <p className="text-[8px] font-semibold uppercase tracking-[0.28em] text-[#9A7B75]">
                                            Our Origin
                                        </p>

                                        <p className="mt-4 max-w-[130px] font-subtitle text-lg italic leading-tight text-[#705752]">
                                            Nepal's hills,
                                            <br />
                                            people & land.
                                        </p>
                                        ...
                                        ].map((chapter, index) =>
                                        {
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <span className="text-[7px] tracking-[0.15em] text-red/60">
                                                        0{index + 1}
                                                    </span>

                                                    <span className="h-px w-0 bg-red transition-all duration-500 group-hover:w-5" />

                                                    <span className="text-[8px] uppercase tracking-[0.2em] text-[#9A7B75] transition-colors duration-300 group-hover:text-brown">
                                                        {chapter}
                                                    </span>
            ...
            ================================================= */}
                                ...
                                <div className="mt-14 flex items-baseline gap-2">
                                    ...
                                    <motion.span className="font-title text-4xl leading-none tracking-[-0.04em] text-brown">
                                        {chapterLabel}
                                    </motion.span>

                                    <span className="text-[8px] tracking-[0.2em] text-[#9A7B75]">
                                        / 04
                                    </span>
                                ...
                                <p className="mt-2 text-[7px] uppercase tracking-[0.3em] text-red">
    ...
    ================================================= */}
                        ...
                        >
                            ...
                            <motion.p
                                ...
                                className="max-w-5xl font-title text-[clamp(2.8rem,5vw,5.5rem)] leading-[0.93] tracking-[-0.05em] text-brown"
                            >
    ...
    ================================================= */}
        ...
        ================================================= */}
                            ...
                            >
                                ...
                                climates and communities. Here, coffee and tea are shaped
                                by altitude, soil, rainfall and seasons.

                                <br />
                                <br />

                                The land is not simply where our products come from.
        ...
        ================================================= */}
                            ...
                            <StoryVisual
                                ...
                                imagePosition="right"
                            >
                                Behind every harvest are people who understand the land
                                through generations of experience.

                                <br />
                                <br />

                                We believe their knowledge, patience and work deserve
                                to be part of the story that reaches your cup.
                            </StoryVisual>
        ...
        ================================================= */}
                            ...
                            <StoryVisual
                                ...
                                imagePosition="left"
                            >
                                From cultivation to processing, every step shapes the
                                character of what eventually reaches you.

                                <br />
                                <br />

                                We care about how something is grown, how it is handled,
                                and how its origin can still be experienced in the final cup.
                            </StoryVisual>
                            ...
                            >
                                ...
                                <div className="border-l border-red/30 pl-7 sm:pl-10">
                                    ...
                                    <p className="mt-7 max-w-3xl font-subtitle text-2xl italic leading-relaxed text-[#705752] sm:text-3xl lg:text-4xl">
                                        Because discovering a product should also mean
                                        discovering the place, people and story behind it.
                                    </p>
...
}) =>
{
    ...
    return (
        <motion.div
            ...
            className={`grid items-center gap-10 lg:grid-cols-12 lg:gap-14 ${imageLeft ? "" : "lg:[&>*:first-child]:order-2"
                }`}
        >
